...
Shader "DLNK/FX/AdvancedGrass" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float2 node_8341 = ((node_7435.r*_WorldNoiseVelocity)*float2(mul(_Object2World, v.vertex).r,mul(_Object2World, v.vertex).b)*0.0001);
            ...
            float node_4834 = (_WorldNoise_var.a*sin((node_7435.r*_UpDownVelocity))*node_7716);
            v.vertex.xyz += ((node_4834*_AnimIntensity*v.normal)+(v.normal*(node_7716*_WeightOffset)));
...
/// Diffuse:
            ...
            float node_9785 = (_WorldNoise_var.a*_WorldNoiseColor);
            float node_8329 = saturate(( (i.uv0.g+_MaskHeight) > 0.5 ? (1.0-(1.0-2.0*((i.uv0.g+_MaskHeight)-0.5))*(1.0-_ColorMask)) : (2.0*(i.uv0.g+_MaskHeight)*_ColorMask) ));
            float3 diffuseColor = saturate(lerp(_ColorRoot.rgb,lerp(_ColorFade.rgb,_ColorTime.rgb,node_9785),saturate(node_8329)));
...
/// Vectors:
            ...
            float node_9785 = (_WorldNoise_var.a*_WorldNoiseColor);
            float node_8329 = saturate(( (i.uv0.g+_MaskHeight) > 0.5 ? (1.0-(1.0-2.0*((i.uv0.g+_MaskHeight)-0.5))*(1.0-_ColorMask)) : (2.0*(i.uv0.g+_MaskHeight)*_ColorMask) ));
            float3 diffColor = saturate(lerp(_ColorRoot.rgb,lerp(_ColorFade.rgb,_ColorTime.rgb,node_9785),saturate(node_8329)));
            o.Albedo = diffColor;
