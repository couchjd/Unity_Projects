...
public class CameraSettings : MonoBehaviour {
    ...
    string fps_local_y_offset;
    string fps_use_smooth_look;
    string fps_smooth_look_time;
    string fps_x_look_sensitivity;
    string fps_y_look_sensitivity;
    string fps_use_bounce;
    string fps_bounce_frequency;
    string fps_bounce_amplitude;
    ...
    public string FPS_LOCAL_Y_OFFSET { get {return fps_local_y_offset; } }
    public string FPS_USE_SMOOTH_LOOK { get {return fps_use_smooth_look; } }
    public string FPS_SMOOTH_LOOK_TIME { get {return fps_smooth_look_time; } }
    public string FPS_X_LOOK_SENSITIVITY { get {return fps_x_look_sensitivity; } }
    public string FPS_Y_LOOK_SENSITIVITY { get {return fps_y_look_sensitivity; } }
    public string FPS_USE_BOUNCE { get {return fps_use_bounce; } }
    public string FPS_BOUNCE_FREQUENCY { get {return fps_bounce_frequency; } }
    public string FPS_BOUNCE_AMPLITUDE { get {return fps_bounce_amplitude; } }
    ...
    void InitializeKeys()
    {
        ...
        fps_local_y_offset = "FPSLocalYOffset";
        fps_use_smooth_look = "FPSUseSmoothLook";
        fps_smooth_look_time = "FPSSMoothLookTime";
        fps_x_look_sensitivity = "FPSXLookSensitivity";
        fps_y_look_sensitivity = "FPSYLookSensitivity";
        fps_use_bounce = "FPSUseBounce";
        fps_bounce_frequency = "FPSBounceFrequency";
        fps_bounce_amplitude = "FPSBounceAmplitude";
    }
